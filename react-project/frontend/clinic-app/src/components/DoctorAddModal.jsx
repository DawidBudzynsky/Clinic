...
export default function AddDoctorModal({ show, handleClose }) {
      ...
      <Modal.Body>
        <Form>
          ...
          <Form.Group className="mb-3" controlId="formBasicSpeciality">
            ...
            <Form.Select aria-label="Speciality" name="speciality" value={formData.speciality} onChange={handleInputChange}>
